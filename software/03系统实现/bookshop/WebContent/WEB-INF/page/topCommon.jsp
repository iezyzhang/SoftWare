...
$(document).ready(function() {
    ...
    $.ajax({
        type: "post",
        url: "<%=basePath%>/fontstage_getNoticeContentToFont",
        dataType:"json",
        scriptCharset: 'utf-8',
       traditional :true, 
       ...
       async:false,
        success: function(data){
                ...
                var noticeRecordList = eval(data);
               /* alert(noticeRecordList); */
              var htmlString = "";
              if(noticeRecordList == null || noticeRecordList == ""){
            	  	 htmlString="<li><a href='#'>没有符合条件的数据</a></li>";
            	  	 $('#printUL').html(htmlString);
              }else{
	               for(var i = 0; i<noticeRecordList.length-1;i++){
	            	   htmlString+="<li><a href='#'>"+noticeRecordList[i].noticeContent+"</a><li>";
	               }
	               $("#printUL").html(htmlString);
              }
        },
